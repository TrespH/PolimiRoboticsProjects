...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(parametersConfig::AbstractParamDescriptionConstPtr(new parametersConfig::ParamDescription<int>("size", "int", 4, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 13, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 14, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 15, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &parametersConfig::size)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(parametersConfig::AbstractParamDescriptionConstPtr(new parametersConfig::ParamDescription<int>("size", "int", 4, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 13, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 14, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 15, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &parametersConfig::size)));
...
//#line 13 "/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg"
      const int parameters_Small = 0;
//#line 14 "/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg"
      const int parameters_Medium = 1;
//#line 15 "/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg"
      const int parameters_Large = 2;
//#line 16 "/home/robotics/catkin_ws/src/parameter_test/parameter_test/cfg/parameters.cfg"
